    ...
    <section id="app" className="py-12 md:py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-black">The App is Ready</h2>
          <p className="text-gray-600 text-base md:text-xl">Experience healing in the palm of your hands</p>
        </div>
        ...
        <div className="space-y-12 md:space-y-20">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`flex flex-col items-center gap-8 md:gap-12 ${index % 2 === 1 ? "md:flex-row-reverse" : "md:flex-row"}`}
            >
              {/* Phone Mockup */}
                ...
                <div className="relative">
                  <div className="w-48 md:w-64 h-[380px] md:h-[500px] bg-black rounded-[2rem] md:rounded-[3rem] p-1.5 md:p-2 shadow-2xl">
                    <div className="w-full h-full bg-white rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden relative">
                      {/* Phone notch */}
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 md:w-32 h-4 md:h-6 bg-black rounded-b-xl z-10"></div>
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="max-w-lg mx-auto md:mx-0">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-gray-900">{feature.title}</h3>

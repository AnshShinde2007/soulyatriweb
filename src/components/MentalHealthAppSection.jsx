...
import therapyImg from "../assets/therapy-session.png"
import moodJournalImg from "../assets/mood-journal.png"
import sleepImg from "../assets/sleep-resources.png"
import exercisesImg from "../assets/exercises.png"

const MentalHealthAppSection = () => {
  const navigate = useNavigate()
  const [activeCard, setActiveCard] = useState(0)
  const [activeTab, setActiveTab] = useState("Online therapy")
  ...
  const cards = [
    ...
    },
    {
      ...
      subtitle: "We gently pair you with a therapist who truly aligns with your emotional needs and healing journey.",
    ...
    },
    {
      ...
      subtitle: "Keep Your Mood Journal with us, we are here to make feel good.",
      buttonText: "Learn more",
      bgColor: "bg-pink-400",
      image: moodJournalImg,
      tab: "Mood Journal",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      subtitle: "Reach your mental health goals with proven courses and expert-led guidance. Check out a preview here.",
      buttonText: "Learn more",
  ...
  // Update active tab based on active card
  useEffect(() => {
    const currentCard = cards[activeCard]
    setActiveTab(currentCard.tab)
  }, [activeCard])

  const handleTabClick = (tabName) => {
    // Find the card index that matches this tab
    const cardIndex = cards.findIndex((card) => card.tab === tabName)
    if (cardIndex !== -1) {
                ...
                >
                  <div className="flex flex-col md:flex-row items-center justify-between h-full">
                    ...
                    <div className="flex-1 mb-8 md:mb-0 md:pr-8">
                      <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">{card.title}</h3>
                      <p className="text-lg md:text-xl mb-6 md:mb-8 opacity-90 leading-relaxed">{card.subtitle}</p>
                      <button

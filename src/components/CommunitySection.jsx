const CommunitySection = () => {
  ...
  return (
    <section id="community" className="py-20 px-4 bg-gradient-to-br from-green-50/30 to-pink-50/30 relative">
      {/* Decorative Elements */}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="mb-6">
                <p className="text-gray-700 leading-relaxed text-base md:text-lg">{testimonial.text}</p>
              </div>
              <div className="border-t border-gray-200 pt-4">
                <p className="text-sm text-gray-500 font-medium">{testimonial.memberType}</p>
              </div>
            </div>
          ))}
        </div>

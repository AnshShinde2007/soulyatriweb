...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-20 px-4 bg-gradient-to-br from-[#FF7B00]/5 to-[#18A2B8]/5">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-[#FF7B00] to-[#18A2B8] bg-clip-text text-transparent">
            Get In Touch
          </h2>
          <p className="text-gray-600 text-lg">Ready to start your journey? We'd love to hear from you.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader>
              <CardTitle className="text-2xl bg-gradient-to-r from-[#FF7B00] to-[#18A2B8] bg-clip-text text-transparent">
                Send us a message
              </CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-[#FF7B00] to-[#18A2B8] bg-clip-text text-transparent">
                  Why Choose Us?
                </h3>

  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Welcome to Your Healing Journey</h2>
          <p className="text-gray-600">Your personalized dashboard for spiritual growth and wellness</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-[#FF7B00]">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Soul Score</h3>
            <div className="text-3xl font-bold text-[#FF7B00] mb-2">85</div>
            <p className="text-gray-600 text-sm">Your spiritual wellness score</p>
          </div>

          {/* Mood Tracker Card */}
          <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-[#18A2B8]">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Today's Mood</h3>

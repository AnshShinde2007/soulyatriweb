        ...
        <div className="p-6">
          <div className="flex items-center space-x-3 mb-8">
            <Avatar className="w-10 h-10">
              ...
              <AvatarFallback className="bg-indigo-100 text-indigo-600">AS</AvatarFallback>
            </Avatar>
              ...
              return (
                <a
                  ...
                  className={`flex items-center space-x-3 px-4 py-3 rounded-full transition-colors ${
                    item.active ? "bg-[#9aafec] text-black" : "text-slate-800 hover:bg-slate-200"
                  }`}
                >
  ...
  return (
    <header className="flex items-center justify-between p-6 md:p-8 bg-white border-b border-gray-200 shadow-sm">
      ...
      <div className="flex items-center gap-4">
        <Button variant="outline" className="flex items-center gap-2 text-gray-700 bg-transparent">
          Notifications
          <Bell className="h-5 w-5" />
        </Button>
        <Avatar className="h-9 w-9">
          <AvatarImage src="/placeholder.svg?height=36&width=36" alt="User Profile" />
        ...
        {sessions.map((session, index) => (
          <Card key={index} className="shadow-sm rounded-lg overflow-hidden">
            <CardContent className="p-4">
              <p className="text-lg font-semibold text-gray-900 mb-1">Client: {session.clientName}</p>
...
function ClientInquiryQueue() {
  ...
  return (
    <section>
      <h3 className="text-lg font-medium text-gray-800 mb-4">Client Inquiry Queue</h3>
    ...
    <section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="shadow-sm rounded-lg">
          <CardHeader>
            <CardTitle className="text-base font-semibold">Session Type Distribution</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex justify-around items-end h-40 gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm text-gray-600 mt-2">Career Guidance</span>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-sm rounded-lg">
          <CardHeader>
            <CardTitle className="text-base font-semibold">Popular Astrologer / Therapy Issues</CardTitle>
          </CardHeader>
            ...
            {popularIssues.map((issue, index) => (
              <div key={index} className="flex items-center gap-4">
                ...
                <div className="flex-1 h-2 bg-gray-200 rounded-full">
                  <div className="h-full bg-purple-500 rounded-full" style={{ width: `${issue.value}%` }} />
                </div>
              </div>
            ))}
          </CardContent>
